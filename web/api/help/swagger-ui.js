...
(function() {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.events = {
      'click #show-client-api': 'showClientApi',
      'click #show-sp-api': 'showSpApi',
    ...
    HeaderView.prototype.showClientApi = function(e) {
      return this.trigger('update-swagger-ui', {
        url: "json/client/resources.php"
      });
    };

    HeaderView.prototype.showSpApi = function(e) {
      return this.trigger('update-swagger-ui', {
        url: "json/sp/resources.php"
      });
    };
