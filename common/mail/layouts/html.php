                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer">
                                                    <tr>
                                                        <td align="center" valign="top" width="500" class="flexibleContainerCell">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" style="text-align: center;background-color: rgb(60, 141, 188);height: 60px;">
                                                                        <h2 style="color:white"><?= Yii::$app->params['projectName'];?></h2>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" bgcolor="#E1E1E1">
                                                                        ...
                                                                        <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                            <div>Copyright &#169; 2015 <a href="<?php Yii::$app->getUrlManager()->createUrl('#'); ?>" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;"><?= Yii::$app->params['projectName'] ?></span></a>. All&nbsp;rights&nbsp;reserved.</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
